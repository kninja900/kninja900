...
chrome.runtime.sendMessage({ifInstagram : true}, function(response) {
    if(window.location.href.indexOf("instagram.com") > -1) {
        ...
        if (regex.test(window.location.href)){
            ...
            // calling mediaJSON function to console.log JSON element TODO
            // console.log(mediaJSON()); TODO
        }
        // alert("you are on an instagram page when you refresh the page"); TODO
    }
});
